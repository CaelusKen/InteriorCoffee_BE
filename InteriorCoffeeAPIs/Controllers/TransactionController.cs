...
namespace InteriorCoffeeAPIs.Controllers
{
    ...
    public class TransactionController : BaseController<TransactionController>
    {
        ...
        {
            string successRedirectUrl = $"https://interi-coffee.vercel.app/orders/{model.vnp_TxnRef}/confirmation/success";
            string failureRedirectUrl = $"https://interi-coffee.vercel.app/orders/{model.vnp_TxnRef}/confirmation/fail";
